# BlindSpot Research Audit Report: Multimodel 0100

## 1. Experiment Metadata & Configuration
- **Experiment ID**: `exp_1790188010_0408e9`
- **Run Plan Created**: `1790188011.163209`
...
- **Probe Set ID / Version**: `pset_1790187956_sel` (v2.2.0)
- **Generator Version**: `2.2.0`
- **Total Selected Probes**: 7
- **Execution Runtime**: 233.04s

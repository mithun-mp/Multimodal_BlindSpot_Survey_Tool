# BlindSpot Research Audit Report: Multimodel Test Run 001

## 1. Experiment Metadata & Configuration
- **Experiment ID**: `exp_1790350109_a4fa36`
- **Run Plan Created**: `1790350109.6300144`
...
- **Probe Set ID / Version**: `pset_1790350062_sel` (v2.2.0)
- **Generator Version**: `2.2.0`
- **Total Selected Probes**: 7
- **Execution Runtime**: 674.36s

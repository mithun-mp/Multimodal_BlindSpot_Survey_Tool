# Probe-Level Behavioral Evidence: Multimodel Robustness Audit 001

**Experiment ID**: `exp_1790018000_c5f75e`
...
| `prb_733b` | STRUCTURE | "The movie was great and t..." → "In fact, the movie was gr..." | POSITIVE (1.00) | POSITIVE (1.00) | POSITIVE → POSITIVE | +0.0 | NO | `EXPECTED_PRESERVE` | **None** |
...
- **`prb_733b`** [None / EXPECTED_PRESERVE]: Model correctly preserved prediction class (POSITIVE → POSITIVE) under meaning-preserving perturbation.
...
| `prb_733b` | STRUCTURE | "The movie was great and t..." → "In fact, the movie was gr..." | POSITIVE (1.00) | POSITIVE (1.00) | POSITIVE → POSITIVE | +0.1 | NO | `EXPECTED_PRESERVE` | **None** |
...
| `prb_733b` | STRUCTURE | "The movie was great and t..." → "In fact, the movie was gr..." | POSITIVE (0.99) | POSITIVE (0.99) | POSITIVE → POSITIVE | +0.1 | NO | `EXPECTED_PRESERVE` | **None** |
...
| `prb_733b` | STRUCTURE | "The movie was great and t..." → "In fact, the movie was gr..." | POSITIVE (0.99) | POSITIVE (0.99) | POSITIVE → POSITIVE | -0.0 | NO | `EXPECTED_PRESERVE` | **None** |

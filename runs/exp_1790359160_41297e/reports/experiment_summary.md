# BlindSpot Research Audit Report: Multimodel Robustness Audit 003

## 1. Experiment Metadata & Configuration
- **Experiment ID**: `exp_1790359160_41297e`
- **Run Plan Created**: `1790359161.6841207`
...
- **Probe Set ID / Version**: `pset_1790359141_sel` (v2.2.0)
- **Generator Version**: `2.2.0`
- **Total Selected Probes**: 7
- **Execution Runtime**: 332.10s
